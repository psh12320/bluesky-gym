...
import json,zipfile
root=Path.cwd();work=root/'runs/cpa-observation-development-v1';assert work.is_dir() and not any(work.iterdir())
changes={}
...
edit('atc_rl/evaluate.py',"'action_reference':config.get('action_reference','direct'),","'action_reference':config.get('action_reference','direct'),'conflict_features':config.get('conflict_features',False),",1)
edit('atc_rl/evaluate.py',"action_reference=config.get('action_reference','direct'),seed=args.seed","action_reference=config.get('action_reference','direct'),conflict_features=config.get('conflict_features',False),seed=args.seed")
