...
The paired MA held-out evaluation is running on 200 seed-2027 scenarios.
...
scores. The MA seed-42 run remains pending. No further checkpoint selection or
...
scenario replays, including five with the frozen SA candidate. The controller code has not changed since those checks.
...
The first additional training seed has completed its twenty-scenario panel on
both tracks and is running the broader replication; see REPLICATIONS.md. A
