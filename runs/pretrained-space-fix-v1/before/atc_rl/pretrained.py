...
def initialize_from_pretrained(model, checkpoint, config, run_directory):
    ...
    if restored.observation_space != model.observation_space or restored.action_space != model.action_space:
        raise ValueError("Pretrained observation/action spaces differ")
