...
class WorldPool(VecEnv):
    def __init__(self,workers,directory,guidance=False,filter=False,progress_scale=0.0,action_reference="direct",conflict_features=False,mask_conflict_features=False,static_filter=False):
