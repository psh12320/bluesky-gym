...
SOURCE=ROOT/"runs/onpolicy-native-source-v1-verify"
...
def main():
    ...
    call("mappo-reference","atc_rl.evaluate","--model",mappo,"--episodes",2,"--seed",20260,
         "--out",WORK/"mappo-reference",source=OLD)
    cases=[
        ("ppo-static",static/"ppo/train/model.zip",static/"ppo/eval-final/aircraft.csv"),
        ("mappo-static",mappo,WORK/"mappo-reference/aircraft.csv"),
