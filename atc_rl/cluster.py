...
def main():
    ...
    paths=[root/'pyproject.toml',root/'README.md',root/'LICENSE',root/'scripts/evaluate_competition.py',root/'docs/competition/NATIVE_POLICY.md',root/'docs/competition/EXPLORATION.md',root/'docs/competition/POSITION_SCALE.md',root/'docs/competition/CREDIT_ASSIGNMENT.md',root/'docs/competition/SAC_COMPARISON.md']
