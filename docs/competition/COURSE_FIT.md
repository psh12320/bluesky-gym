...
200 unseen scenarios, but safety differences remain uncertain. The completed MA
held-out comparison has 99.35% arrivals for both learned and classical control,
with no clear overall learned advantage. All three SA training seeds have now
completed the same 200-scenario replication stream: arrivals are 100%, 98% and
99%, versus 97% for classical control. The first additional MA seed reaches 99.20% arrivals, again without a clear
learned advantage. The final MA replica reaches 99.30% arrivals and 94.45% clean completion, again with all nontrivial paired intervals including zero. All declared replications are complete. Full corrected SA/MA
competition-protocol evaluations are running. The number
of experiments alone is not evidence of innovation or a high grade.
